...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="main-menu__wrapper-inner">
                                    ...
                                    <ul class="main-menu__list">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="seo-content-writting.html">SEO & Content Writting</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a href="#">Projects
                            ...
                            <div class="main-menu__right">
                                <div class="main-menu__btn-box">
                                    <a href="https://wa.me/6287841843284" class="main-menu__btn thm-btn">
                                        <span style="display: inline-flex; align-items: center; justify-content: center; height: 100%;">
                                            <i class="fab fa-whatsapp" style="vertical-align: middle; font-size: 1.2em;"></i>
                                ...
                                <div class="col-xl-12">
                                    <div class="main-slider__content">
                                        ...
                                        <div class="main-slider__btn-box">
                                            <a href="contact.html" class="main-slider__btn thm-btn">Get Free Quote</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5">
                        <div class="contact-one__left wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <form class="contact-form-validated contact-one__form" action="https://unicktheme.com/zefxa/assets/inc/sendemail.php"
                        ...
                        <div class="process-one__single-inner">
                            ...
                            <div class="process-one__single">
                                <div class="process-one__single-bg"
                                    style="background-image: url(assets/images/resources/process-one-single-bg.jpg);">
                                </div>
        ...
        <section class="why-we-are">
            <div class="why-we-are__bg" style="background-image: url(assets/images/backgrounds/why-we-are-bg.jpg);">
            </div>
            <div class="why-we-are__bg-shape"
                style="background-image: url(assets/images/shapes/why-we-are-bg-shape.png);"></div>
                        ...
                        <div class="swiper-container" id="testimonial-one__thumb">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-one__img-holder-box">
                                        <div class="testimonial-one__img-holder">
                                            <img src="assets/images/testimonial/testimonial-thumb-1-1.jpg" alt="">
                                        </div>
                                    </div>
                                </div><!-- /.swiper-slide -->
                                <div class="swiper-slide middle">
                                    <div class="testimonial-one__img-holder-box">
                                        <div class="testimonial-one__img-holder">
                                            <img src="assets/images/testimonial/testimonial-thumb-1-2.jpg" alt="">
                                        </div>
                                    </div>
                                </div><!-- /.swiper-slide -->
                                <div class="swiper-slide">
                                    <div class="testimonial-one__img-holder-box">
                                        <div class="testimonial-one__img-holder">
                                            <img src="assets/images/testimonial/testimonial-thumb-1-3.jpg" alt="">
                                        </div>
                                    </div>
                                </div><!-- /.swiper-slide -->
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3 class="blog-one__title"><a href="blog-details.html">Working together, ideas come to
                                        life</a></h3>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3 class="blog-one__title"><a href="blog-details.html">Five ways that can develop your
                                        business</a></h3>
                                <p class="blog-one__text">Business is the activity of making one's
                                    livcing or buying & selling products.</p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInRight" data-wow-delay="300ms">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3 class="blog-one__title"><a href="blog-details.html">Get few solutions to make a best
                                        website</a></h3>
                                <p class="blog-one__text">Business is the activity of making one's
                                    livcing or buying & selling products.</p>
                            </div>
                ...
                <div class="row">
                    <div class="cta-one__inner">
                        ...
                        <div class="cta-one__btn-box">
                            <a href="about.html" class="cta-one__btn thm-btn">Let's Start</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index-2.html" aria-label="logo image"><img src="assets/images/resources/logo-1.png" width="150"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->
...
<!-- Mirrored from unicktheme.com/zefxa/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 May 2025 09:25:43 GMT -->
</html>
